...
func _physics_process(delta):
	...
	move_and_slide()
	# Demon's boundaries are handled by collision walls in the scene
...
func check_hit():
	...
	for enemy in enemies:
		...
		print("Player 2 attacking! Horizontal distance to enemy: ", horizontal_distance)
		...
		if horizontal_distance <= attack_range:
			...
			print("Player 2 attack missed - too far!")
